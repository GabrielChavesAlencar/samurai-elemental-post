...
public class Menu : MonoBehaviour
{
    ...
    public GameObject menu_controle;
    ...
    public void voltar() { creditos.SetActive(false); config.SetActive(false); menu_controle.SetActive(false);menu_principal.SetActive(true); ativar_som(); }
    public void credits() { menu_principal.SetActive(false); creditos.SetActive(true); ativar_som(); }
    public void configuracoes() { menu_principal.SetActive(false); config.SetActive(true);  menu_controle.SetActive(false);ativar_som(); }
    public void jogar() { SceneManager.LoadScene("jogo"); ativar_som(); }
    public void sair() { Application.Quit(); ativar_som(); }
    public void ir_controles(){config.SetActive(false);menu_controle.SetActive(true);ativar_som();}
